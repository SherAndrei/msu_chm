...
static void GenerateChebyshevNodes(unsigned N, double left, double right, double* x) {
...
static void GenerateEquallyDistributedNodes(unsigned N, double left, double right, double* x) {
...
static void GenerateRandomNodes(unsigned N, double left, double right, double* x) {
